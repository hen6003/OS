...
MB_MAGIC equ 0x1BADB002          ; This is a 'magic' constant that GRUB will use to detect our kernel's location.
MB_FLAGS equ (1 << 0) | (1 << 1) ; This tells GRUB to 1: load modules on page boundaries and 2: provide a memory map (this is useful later in development)
...
section .bss
  ...
  align 16
  stack_bottom:
    resb 4096 ; Reserve a 4096-byte (4K) stack
  stack_top:
